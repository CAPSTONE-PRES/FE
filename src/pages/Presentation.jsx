...
const sectionMembers = {
  1: [
    { id: "u1", name: "박민영", avatar: "/avatars/user1.svg" },
    { id: "u3", name: "이호성", avatar: "/avatars/user3.svg" },
  ],
  2: [
    { id: "u4", name: "김소영", avatar: "/avatars/user4.svg" },
    { id: "u5", name: "김현서", avatar: "/avatars/user1.svg" },
  ],
  3: [
    { id: "u2", name: "김민지", avatar: "/avatars/user2.svg" },
    { id: "u5", name: "김현서", avatar: "/avatars/user1.svg" },
  ],
  4: [
    { id: "u6", name: "김승빈", avatar: "/avatars/user2.svg" },
    { id: "u3", name: "이호성", avatar: "/avatars/user3.svg" },
  ],
};
...
const Presentation = () => {
  ...
  // 체크 토글 핸들러
  const handleCheckToggle = (section) => {
  ...
  useEffect(() => {
    const slideData = backendResponse.slides[currentIndex];
    if (!slideData) return;
      ...
      <div className="Presentation__panel">
        ...
        >
          <div className={"Presentation__right"}>
            ...
            >
              {cueCards.map((card) => {
                const members = sectionMembers[card.section];
                        ...
                        >
                          <div className="Presentation__review-cue">
                            <label className="Presentation__checkbox">
                              <input
                                type="checkbox"
                                checked={!!checkedSections[card.section]}
                                onChange={() => handleCheckToggle(card.section)}
